...
add_filter('wp_nav_menu_items', function ($nav, $args) {
    ...
    if ($args->theme_location == 'quick_navigation') {
        $nav .= '<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-especial"><a role="link" class="flex" id="" href="' . get_field('ambientes_virtuais_link', 'option') . '"><span>' . get_field('ambientes_virtuais_title', 'option') . '</span><img src="' . get_template_directory_uri() . '/resources/images/svg/icon/caret.svg" /></a><ul>';
        ...
        $nav .= '<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-especial"><a role="link" class="flex" id="" href="' . get_field('ambientes_virtuais_link_02', 'option') . '"><span>' . get_field('ambientes_virtuais_title_02', 'option') . '</span><img src="' . get_template_directory_uri() . '/resources/images/svg/icon/caret.svg" /></a><ul>';
