...
*/.footer-navigation{
  ...
  width: 100%;
}.wp-block-its-tabs ul.tab-labels{
  margin: 0px;
  gap: 1px;
  padding: 0px;
        list-style: none;
}.wp-block-its-tabs ul.tab-labels .tab-label{
  display: flex;
  cursor: pointer;
  align-items: center;
  gap: 0.5rem;
  ...
  transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1);
  transition-duration: 150ms;
}.wp-block-its-tabs ul.tab-labels .tab-label img{
  height: 1rem;
  width: 1rem;
}.wp-block-its-tabs.columns-tab-layout ul.tab-labels{
  display: grid;
  grid-auto-columns: auto;
  grid-auto-flow: row;
}@media (min-width: 768px){.wp-block-its-tabs.columns-tab-layout ul.tab-labels{
    grid-auto-flow: column;
  }
}.wp-block-its-tabs.columns-tab-layout ul.tab-labels .tab-label{
  border-top-left-radius: 0.75rem;
  border-top-right-radius: 0.75rem;
  ...
  padding-left: 1.5rem;
  padding-right: 1.5rem;
}.wp-block-its-tabs.columns-tab-layout ul.tab-labels .tab-label img{
  height: 1rem;
  width: 1rem;
}.wp-block-its-tabs.columns-tab-layout ul.tab-labels .tab-label.active{
  border-top-width: 4px;
  --tw-border-opacity: 1;
  ...
  background-color: rgba(243, 244, 246, 1);
  background-color: rgba(243, 244, 246, var(--tw-bg-opacity));
}.wp-block-its-tabs.rows-tab-layout{
  display: flex;
  flex-direction: row;
}.wp-block-its-tabs.rows-tab-layout ul.tab-labels{
  width: -moz-fit-content;
  width: fit-content;
  min-width: 20%;
  grid-auto-flow: row;
}.wp-block-its-tabs.rows-tab-layout ul.tab-labels .tab-label{
  width: 100%;
  ...
  padding-left: 0.75rem;
  padding-right: 1.25rem;
}.wp-block-its-tabs.rows-tab-layout ul.tab-labels .tab-label img{
  height: 1rem;
  width: 1rem;
}.wp-block-its-tabs.rows-tab-layout ul.tab-labels .tab-label.active{
  border-left-width: 4px;
  --tw-border-opacity: 1;
  border-color: rgba(187, 247, 208, 1);
  border-color: rgba(187, 247, 208, var(--tw-border-opacity));
  ...
  background-color: rgba(243, 244, 246, 1);
  background-color: rgba(243, 244, 246, var(--tw-bg-opacity));
}.wp-block-its-tabs .tab-content{
  width: 100%;
}.wp-block-its-tabs .tab-content .tab-panel{
  display: none;
  height: 100%;
  --tw-bg-opacity: 1;
  background-color: rgba(243, 244, 246, 1);
  background-color: rgba(243, 244, 246, var(--tw-bg-opacity));
  padding: 2.5rem;
}.wp-block-its-tabs .tab-content .tab-panel.active{
  display: block;
...
.heading-4{
  ...
  outline-offset: 2px;
}.gform_wrapper input:not([disabled]):not([type="submit"])::placeholder,
    .gform_wrapper select::placeholder,
    .gform_wrapper textarea::placeholder{
  text-transform: uppercase;
  color: rgba(47, 49, 141, 0.3);
}.gform_wrapper input:not([disabled]):not([type="submit"]):focus,
  ...
  border-color: rgba(75, 85, 99, var(--tw-border-opacity));
    ...
    .gform_wrapper .submit-button button{
  display: inline-block;
  cursor: pointer;
  justify-content: center;
  border-radius: 9999px;
  ...
  color: rgba(255, 255, 255, var(--tw-text-opacity));
    ...
    .gform_wrapper .submit-button button:hover{
  --tw-bg-opacity: 1;
  background-color: rgba(199, 210, 254, 1);
  background-color: rgba(199, 210, 254, var(--tw-bg-opacity));
  --tw-text-opacity: 1;
...
//# sourceMappingURL=app.85016bbb7104b2d1.hot-update.js.map